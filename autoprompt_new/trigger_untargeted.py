...
logfile = "/home/zsarwar/NLP/autoprompt/autoprompt/Results/Logs/Relationships/untargeted/"+ str(args.train).split("/")[-1].split(".")[0]  +  "_" + args.logfile    
numpy_file = "/home/zsarwar/NLP/autoprompt/autoprompt/Results/Arrays/Relationships/untargeted/" + str(args.train).split("/")[-1].split(".")[0]  +  "_" + args.logfile + ".npy"
